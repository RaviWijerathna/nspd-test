...
const PROVINCE_DATA = {
  'බස්නාහිර පළාත / மேற்கு மாகாணம் / Western Province': {
    ...
    divisions: {
      'කොළඹ දිස්ත්‍රික්කය / கொழும்பு மாவட்டம் / Colombo District': ['කොළඹ / கொழும்பு / Colombo', 'දෙහිවල / தெஹிவளை / Dehiwala', 'මොරටුව / மொரட்டுவை / Moratuwa', 'ශ්‍රී ජයවර්ධනපුර කෝට්ටේ / ஸ்ரீ ஜயவர்தனபுர கோட்டை / Sri Jayawardenepura Kotte', 'මහරගම / மகரகம / Maharagama', 'කැස්බෑව / கேஸ்பேவ / Kesbewa', 'හෝමාගම / ஹோமாகம / Homagama', 'පාදුක්ක / பாதுக்கா / Padukka', 'කඩුවෙල / கடுவெல / Kaduwela', 'හංවැල්ල /	ஹன்வெல்ல /	Hanwella', 'තිඹිරිගස්යාය / திம்பிரிகஸ்யாய / Thimbirigasyaya', 'කොලොන්නාව	/ கொலன்னாவ /	Kolonnawa', 'රත්මලාන /	இரத்மலானை /	Rathmalana'],
      'ගම්පහ දිස්ත්‍රික්කය / கம்பஹா மாவட்டம் / Gampaha District': ['ගම්පහ / கம்பஹா / Gampaha', 'මීගමුව / நீர்கொழும்பு / Negombo', 'කටාන / கட்டான / Katana', 'දිවුලපිටිය / திவுலபிட்டிய / Divulapitiya', 'මිරිගම / மிரிகம / Mirigama', 'මිනුවන්ගොඩ / மினுவங்கொட / Minuwangoda', 'අත්තනගල්ල / அத்தனகல்ல / Attanagalla', 'ජාඇල / ஜா-எல / Ja-Ela', 'වත්තල / வத்தளை / Wattala', 'මහර / மஹார / Mahara', 'දොම්පෙ / தொம்பே / Dompe', 'කැලණිය / கெலணியா / Kelaniya', 'බියගම / பியாகம / Biyagama'],
      'කළුතර දිස්ත්‍රික්කය / களுத்துறை மாவட்டம் / Kalutara District': ['කළුතර / களுத்துறை / Kalutara', 'පානදුර / பாணந்துறை / Panadura', 'බණ්ඩාරගම / பண்டாரகம / Bandaragama', 'හොරණ / ஹொரணை / Horana', 'බුලත්සිංහල / புலத்சிங்கல / Bulathsinhala', 'මදුරාවල / மதுராவள / Madurawela', 'දොඩංගොඩ / தொடங்கொட / Dodangoda', 'මතුගම / மாதுகம / Mathugama', 'අගලවත්ත / அகலவத்த / Agalawatta', 'පාලින්දනුවර / பாலிந்தனுவர / Palindanuwara', 'වලල්ලාවිට / வலல்லாவிட்ட / Walallawita', 'බේරුවල /	பேருவளை	/ Beruwala', 'ඉංගිරිය /	இங்கிரிய /	Ingiriya', 'මිල්ලනිය	/ மில்லனிய /	Millaniya']
    }
  },
  'මධ්‍යම පළාත / மத்திய மாகாணம் / Central Province': {
    ...
    divisions: {
      'මහනුවර දිස්ත්‍රික්කය / கண்டி மாவட்டம் / Kandy District': ['අකුරණ / அகுரணை / Akurana', 'පූජාපිටිය / பூஜாபிட்டிய / Pujapitiya', 'පාතදුම්බර / பத்ததும்பர / Pathadumbara', 'හාරිස්පත්තුව / ஹரிஸ்பத்துவ / Harispattuwa', 'යටිනුවර / யதிநுவர / Yatinuwara', 'ගඟවටකොරළේ / கங்கவடகொரளை / Gangawata Korale', 'උඩදුම්බර / உடுதும்பர / Ududumbara', 'පස්බාගේ කොරළේ / பஸ்பாகே கொரளை / Pasbage Korale', 'ගඟ ඉහළ කොරළේ / கங்க இஹல கொரளை / Gangaihala Korale', 'දෙල්තොට / டெல்தோட்ட / Deltota', 'කුණ්ඩසාලේ / குந்தசாலை / Kundasale', 'මිනිපේ - හසලක / மினிப்பே - ஹசலக / Minipe - Hasalaka', 'මැදදුම්බර / மெததும்பர / Medadumbara', 'උඩුනුවර / உடுநுவர / Udunuwara', 'දොලුව ගම්පොළ / தொலுவ கம்பளை / Doluwa Gampola', 'උඩපළාත ගම්පොළ /	உடபலாத்தை கம்பளை /	Udapalatha Gampola', 'පාතහේවාහැට /	பாதஹேவாஹெட்ட /	Pathahevahata', 'ගලගෙදර තුම්පනේ /	கலகெதர தும்ப்பனை /	Galagedara Thumpane', 'හතරලියද්ද /	ஹத்தரலியத்த /	Hatharaliyadda','පන්විල	/ பன்வில	/ Panwila'],
      'මාතලේ දිස්ත්‍රික්කය / மாத்தளை மாவட்டம் / Matale District': ['මාතලේ / மாத்தளை / Matale', 'දඹුල්ල / தம்புள்ள / Dambulla', 'ගලේවෙල / கலேவெல / Galewela', 'රත්තොට / ரத்தோட்ட / Rattota', 'උකුවෙල / உகுயெல / Ukuwela', 'නාඋල / நாவுல / Naula', 'විල්ගමුව / வில்கமுவ / Wilgamuwa', 'අම්බන්ගඟ කොරළේ / அம்பன்கங்க கொரளை / Ambanganga Korale', 'ලග්ගල / லக்கல / Laggala-Pallegama', 'පල්ලේපොළ /	பல்லேபொல /	Pallepola', 'යටවත්ත /	யடவத்தை /	Yatawatta'],
      'නුවරඑළිය දිස්ත්‍රික්කය / நுவரெலியா மாவட்டம் / Nuwara Eliya District': ['නුවරඑළිය / நுவரெலியா / Nuwara Eliya', 'හඟුරන්කෙත / ஹங்குரங்கெத்த / Hanguranketha', 'කොත්මලේ / கொத்மலை / Kothmale', 'වලපනේ / வலப்பனே / Walapane', 'අඹගමුව / அம்பகமுவ / Ambagamuwa', 'තලවකැලේ	/ தலவாக்கலை /	Thalawakele','නෝර්වුඩ් /	நோர்வூட்	/ Norwood']
    }
  },
  'දකුණු පළාත / தெற்கு மாகாணம் / Southern Province': {
    ...
    divisions: {
      'ගාල්ල දිස්ත්‍රික්කය / காலி மாவட்டம் / Galle District': ['අක්මීමන / அக்மீமன / Akmeemana', 'බලපිටිය / பலபிட்டிய / Balapitiya', 'බෙන්තොට / பெந்தோட்ட / Bentota', 'ඇල්පිටිය / எல்பிட்டிய / Elpitiya', 'ගෝනපිනුවල / கோனபினுவல / Gonapinuwala', 'හබරාදුව / ஹபராதுவ / Habaraduwa', 'හික්කඩුව / ஹிக்கடுவ / Hikkaduwa', 'ඉමදුව / இமதுவ / Imaduwa', 'නෙළුව / நெழுவ / Neluwa', 'වැලිවිටිය දිවිතුර /	வெலிவிட்டிய திவிதுர /	Welivitiya Divithura', 'යක්කලමුල්ල / யக்கலமுல்ல / Yakkalamulla', 'බද්දේගම /	பத்தேகம /	Baddegama', 'බෝපේ පෝද්දල / பூப்பே போத்தல / Boope Poddala', 'නියාගම / 	நியகம /	Niyagama', 'තවලම /	தவலம /	Thavalama', 'කඩවත් සතර /	கடவத் சதர /	Kadavat Sathara', 'මාදම්පාගම /	மாதம்பாகம /	Maadampaagama', 'රත්ගම /	ரத்கம	/ Rathgama', 'වඳුරඹ /	வந்துரம்ப /	Vanduramba', 'නාගොඩ /	நாகொட	/ Nagoda', 'කරන්දෙණිය /	கரந்தெனிய /	Karandeniya', 'අම්බලන්ගොඩ /	அம்பலாங்கொடை /	Ambalangoda'],
      'මාතර දිස්ත්‍රික්කය / மாத்தறை மாவட்டம் / Matara District': ['මාතර / மாத்தறை / Matara', 'අකුරැස්ස / அக்குரெஸ்ஸ / Akuressa', 'අතුරලිය / அத்துரலிய / Athuraliya', 'දෙවිනුවර / தேவிநுவர / Devinuwara', 'දික්වැල්ල / திக்குவல்ல / Dickwella', 'හක්මන / ஹக்மண / Hakmana', 'කඹුරුපිටිය / கம்புறுப்பிட்டிய / Kamburupitiya', 'කිරින්ද පුහුල්වැල්ල / கிரிந்த புஹுல்வெல்ல / Kirinda Puhulwella', 'කොටපොල / கொட்டப்பொல / Kotapola', 'මාලිම්බඩ / மலிம்பட / Malimbada', 'පස්ගොඩ / பஸ்கொட / Pasgoda', 'පිටබැද්දර / பிடபட்டர / Pitabeddara', 'වැලිගම / வெலிகம / Weligama', 'වැලිපිටිය /	வெலிபிட்டிய /	Velipitiya', 'තිහගොඩ /	திஹகொட /	Thihagoda', 'මුලටියන / முலட்டியன / Mulatiyana'],
      'හම්බන්තොට දිස්ත්‍රික්කය / ஹம்பாந்தோட்டை மாவட்டம் / Hambantota District': ['හම්බන්තොට / ஹம்பாந்தோட்டை / Hambantota', 'අම්බලන්තොට / அம்பலாந்தோட்டை / Ambalantota', 'අඟුණකොළපැලැස්ස / அங்குனுகொலபெலஸ்ஸ / Angunakolapelessa', 'බෙලිඅත්ත / பெலியட்ட / Beliatta', 'ලුණුගම්වෙහෙර / லுணுகம்வெஹெர / Lunugamvehera', 'ඕකෙවෙල / ஒகெவெல / Okewela', 'සූරියවැව / சூரியவெவ / Sooriyawewa', 'තංගල්ල / தங்கல்ல / Tangalle', 'තිස්සමහාරාම / திஸ்ஸமஹாராம / Tissamaharama', 'වීරකැටිය / வீரகெட்டிய / Weeraketiya', 'වලස්මුල්ල	/ வலஸ்முல்ல /	Walasmulla', 'කටුවන /	கட்டுவன /	Katuwana']
    }
  },
  'උතුරු පළාත / வடக்கு மாகாணம் / Northern Province': {
    ...
    divisions: {
      'යාපනය දිස්ත්‍රික්කය / யாழ்ப்பாணம் மாவட்டம் / Jaffna District': ['යාපනය / யாழ்ப்பாணம் / Jaffna', 'ඩෙල්ෆ්ට් / டெல்ஃப்ட் / Delft', 'කයිට්ස් / கைட்ஸ் / Kayts', 'නල්ලූර් / நல்லூர் / Nallur', 'සන්දිලිප්පයි / சந்திலிப்பாய் / Sandilipay', 'චාවකච්චේරි / சாவகச்சேரி / Chavakachcheri', 'උඩුවිල් / உடுவில் / Uduvil', 'පොයින්ට් පේඩ්රෝ / பொயிண்ட் பேட்ரோ / Point Pedro', 'කොපයි / கோப்பாய் / Kopay', 'කරයිනගර් / கரைநகர் / Karainagar', 'තෙලිප්පලෙයි / தெல்லிப்பழை / Tellippalai', 'කරවෙඩ්ඩි /	கரவெட்டி /	Karaveddy','වේලනයි /	வேலணை /	Velanai','චංගනෙයි / சங்கானைChankanai / Changanai','මරුදන්කේණි /	மருதங்கேணி /	Maruthankeny'],
      'කිලිනොච්චි දිස්ත්‍රික්කය / கிளிநொச்சி மாவட்டம் / Kilinochchi District': ['කන්ඩවලයි / கண்டவல் / Kandavalai', 'කරයිච්චි / கரச்சி / Karaichchi', 'පච්චිලායිපල්ලී / பச்சிலைப்பள்ளி / Pachchilaipalli','පූනකරි /	பூநகரி /	Poonakary'],
      'මන්නාරම දිස්ත්‍රික්කය / மன்னார் மாவட்டம் / Mannar District': ['මන්නාරම නගරය /	மன்னார் நகரம் /	Mannar Town', 'මන්තයි බටහිර / மாந்தை மேற்கு / Manthai West', 'මුසලි / முசலி / Musaly', 'නානාට්ටන් /	நானாட்டான் /	Nanaddan','මඩු /	மடு /	Madhu'],
      'වවුනියාව දිස්ත්‍රික්කය / வவுனியா மாவட்டம் / Vavuniya District': ['වවුනියාව / வவுனியா / Vavuniya', 'වවුනියාව උතුර / வவுனியா வடக்கு / Vavuniya North', 'වවුනියාව දකුණ / வவுனியா தெற்கு / Vavuniya South', 'වෙන්ගලචෙට්ටිකුලම /	வெங்கலச்செட்டிகுளம் /	Vengalacheddikulam'],
      'මුලතිව් දිස්ත්‍රික්කය / முல்லைத்தீவு மாவட்டம் / Mullaitivu District': [ 'මැරිටයිම්පත්තූ /	கரைதுறைப்பற்று /	Maritimepattu', 'ඔඩ්ඩුසුඩාන් /	ஒட்டுசுட்டான் /	Odduchuddan', 'පුදුකුඩිඉරිප්පු	/ புதுக்குடியிருப்பு /	Puthukudiyiruppu', 'තුනුක්කායි /	துணுக்காய் /	Thunukkai', 'වැලිඔය /	வெலிஓயா /	Welioya','මාන්තෛ නැගෙනහිර /	மாந்தை கிழக்கு /	Manthai East']
    }
  },
  'නැගෙනහිර පළාත / கிழக்கு மாகாணம் / Eastern Province': {
    districts: [
      'ත්‍රීකුණාමලය දිස්ත්‍රික්කය / திருகோணமலை மாவட்டம் / Trincomalee District',
  ...
  'වයඹ පළාත / வடமேற்கு மாகாணம் / North Western Province': {
    ...
    divisions: {
      'කුරුණෑගල දිස්ත්‍රික්කය / குருநாகல் மாவட்டம் / Kurunegala District': ['කුරුණෑගල / குருநாகல் / Kurunegala', 'අලව්ව / அலவ்வ / Alawwa', 'අඹන්පොල / அம்பன்பொல / Ambanpola', 'බිංගිරිය / பிங்கிரிய / Bingiriya', 'උඩුබද්දාව / உடுபத்தாவ / Udubaddawa', 'ගල්ගමුව / கல்கமுவ / Galgamuwa', 'ගිරිබාව / கிரிபாவ / Giribawa', 'ඉබ්බාගමුව / இப்பாகமுவ / Ibbagamuwa', 'කොබෙයිගනේ / கொப்பெய்கனே / Kobeigane', 'කොටවෙහෙර / கொட்டவெஹெர / Kotavehera', 'කුලියාපිටිය නැගෙනහිර / குலியாப்பிட்டிய கிழக்கு / Kuliyapitiya East', 'කුලියාපිටිය බටහිර / குலியாப்பிட்டிய மேற்கு / Kuliyapitiya West', 'මහව / மஹவ / Mahawa', 'මල්ලවපිටිය / மல்லவப்பிட்டிய / Mallawapitiya', 'මාවතගම / மாவத்தகம / Mawathagama', 'නාරම්මල / நாரம்மல / Narammala', 'නිකවැරටිය / நிகவரட்டிய / Nikaweratiya', 'පන්නල / பன்னல / Pannala', 'පොල්ගහවෙල / பொல்கஹவெல / Polgahawela', 'පොල්පිතිගම / பொல்பித்திகம / Polpithigama', 'රස්නායකපුර / ரஸ்நாயகபுர / Rasnayakaapura', 'රිදීගම / ரிதிகம / Rideegama', 'වාරියපොල / வரியப்பொல / Wariyapola', 'වීරඹුගෙදර / வீரம்புகெதர / Weerambugedara', 'ඇහැටුවැව /	எஹெடுவெவ /	Ahetuwewa', 'ගනේවත්ත /	கனேவத்த /	Ganevaththa', 'මාස්පොත /	மாஸ்பொத்த /	Maaspotha', 'පඬුවස්නුවර නැගෙනහිර / பண்டுவஸ்னுவர கிழக்கு / Panduvasnuwara East ', 'පඬුවස්නුවර බටහිර /	பண்டுவஸ்னுவர மேற்கு /	Panduwasnuwara West', 'බමුණාකොටුව /	பமுணாகொடுவ /	Bamunakotuwa'],
      'පුත්තලම දිස්ත්‍රික්කය / புத்தளம் மாவட்டம் / Puttalam District': ['පුත්තලම / புத்தளம் / Puttalam', 'ආණමඩුව / அனம்மடுவ / Anamaduwa', 'ආරච්චිකට්ටුව / ஆரச்சிக்கட்டுவ / Arachchikattuwa', 'කල්පිටිය / கல்பிட்டிய / Kalpitiya', 'කරුවලගස්වැව / கருவலகஸ்வேவ / Karuwalagaswewa', 'මහකුඹුක්කඩවල / மககும்புக்கடவல / Mahakumbukkadawala', 'මහවැව / மஹவெவ / Mahawa', 'මුන්දලම / முண்டலம / Mundalama', 'නාත්තන්ඩිය / நத்தாண்டிய / Nattandiya', 'නවගත්තේගම / நவகத்தேகம / Nawagattegama', 'පල්ලම / பல்லம / Pallama', 'වෙන්නප්පුව / வெண்ணப்புவ / Wennappuwa', 'දංකොටුව /	தன்கொடுவ /	Dankotuwa', 'වනාතවිල්ලුව /	வனாதவில்லுவ /	Wanathavilluwa', 'මාදම්පේ /	மாதம்பே /	Madampe', 'හලාවත /	சிலாபம் /	Chilaw']
    }
  },
  'උතුරු මැද පළාත / வட மத்திய மாகாணம் / North Central Province': {
    ...
    divisions: {
      'අනුරාධපුර දිස්ත්‍රික්කය / அனுராதபுரம் மாவட்டம் / Anuradhapura District': ['ගල්නෑව / கல்நேவ / Galnewa', 'ගලෙන්බිඳුණුවැව / கலெண்பிந்துணுவெவ / Galenbindunuwewa', 'හොරොව්පතාන / ஹொரோவ்பத்தான / Horowpothana', 'ඉපලෝගම / இபலோகம / Ipalogama', 'කහටගස්දිගිලිය / கஹடகஸ்திகிலிய / Kahatagasdigiliya', 'කැබිතිගොල්ලෑව / கெபிதிகொல்லாவ / Kebithigollewa', 'මැදවච්චිය / மெதவச்சிய / Medawachchiya', 'මිහින්තලේ / மிஹிந்தலை / Mihintale', 'නාච්චාදූව / நச்சதுவ / Nachchaduwa', 'නොච්චියාගම / நொச்சியாகம / Nochchiyagama', 'නුවරගම්පලාත මධ්‍යම / நுவரகம்பலாத மத்திய / Nuwaragam Palatha Central', 'නුවරගම්පලාත නැගෙනහිර /	நுவரகம்பலாத கிழக்கு /	Nuwaragam Palatha East', 'පදවිය / பதவியா / Padaviya', 'පලාගල / பலகல / Palagala', 'රාජාංගනය / ராஜாங்கனய / Rajanganaya', 'තඹුත්තේගම / தம்புத்தேகம / Thambuttegama', 'තිරප්පනේ / திரப்பனே / Thirappane', 'තලාව /	தலாவ	/ Thalawa', 'කැකිරාව /	கெக்கிராவ	/ Kekirawa', 'පලුගස්වැව /	பலுகஸ்வெவ /	Palugaswewa', 'මහවිලච්චිය /	மகாவிலச்சிய /	Mahawilachchiya', 'රඹෑව /	ரம்பேவ	/ Rambewa'],
      'පොළොන්නරුව දිස්ත්‍රික්කය / பொலன்னறுவை மாவட்டம் / Polonnaruwa District': ['දිඹුලාගල / தம்பலகஸ்வேவ / Dimbulagala', 'හිඟුරක්ගොඩ / ஹிங்குரக்கொட / Hingurakgoda', 'ලංකාපුර / லங்காபுர / Lankaapura', 'මැදිරිගිරිය / மெதிரிகிரிய / Medirigiriya', 'තමන්කඩුව / தமன்கடுவ / Thamankaduwa', 'වැලිකන්ද /	வெலிகந்த /	Welikanda', 'ඇලහැර	/ எலஹெர /	Elahera']
    }
  },
  'ඌව පළාත / ஊவா மாகாணம் / Uva Province': {
    ...
    divisions: {
      'බදුල්ල දිස්ත්‍රික්කය / பதுளை மாவட்டம் / Badulla District': ['බදුල්ල / பதுளை / Badulla', 'බණ්ඩාරවෙල / பண்டாரவெல / Bandarawela', 'හල්දුම්මුල්ල / ஹல்தும்முல்ல / Haldummulla', 'හාලිඇල / ஹாலிஎல / Hali-Ela', 'කන්දකැටිය / கண்டகெட்டிய / Kandaketiya', 'මහියංගනය / மஹியங்கண / Mahiyanganaya', 'මීගහකිවුල / மீகஹகிவுல / Meegahakivula', 'පස්සර / பஸ்ஸர / Passara', 'රිදීමාලියද්ද / ரிதிமாலியத்த / Rideemaliyadda', 'සොරණාතොට / சோரணத்தொட்ட / Soranathota', 'ඌවපරණගම / உவபரணகம / Uva Paranagama', 'ඇල්ල	/ எல்ல /	Ella', 'හපුතලේ	/ ஹப்புத்தளை /	Haputale', 'ලුණුගල /	லூணுகலை /	Lunugala', 'වැලිමඩ /	வெலிமடை	/ Welimada'],
      'මොණරාගල දිස්ත්‍රික්කය / மொணராகலை மாவட்டம் / Monaragala District': ['මොණරාගල / மொணராகலை / Monaragala', 'බිබිල / பிபில / Bibile', 'බුත්තල / புத்தல / Buttala', 'කතරගම / கதிர்காமம் / Kataragama', 'දඹගල්ල මඩුල්ල / தம்பகல்ல மதுல்ல / Dambagalla Madulla', 'සියඹලාණ්ඩුව / சியம்பலாண்டுவ / Siyambalanduwa', 'තණමල්විල / தனமல்வில / Thanamalvila', 'වැල්ලවාය / வெல்லவய / Wellawaya', 'බඩල්කුඹුර /	பதல்கும்புர /	Badalkumbura', 'මැදගම	/ மேதகம /	Medagama', 'සෙවනගල /	செவனகல /	Sevanagala']
    }
  },
  'සබරගමුව පළාත / சபரகமுவ மாகாணம் / Sabaragamuwa Province': {
    ...
    divisions: {
      'රත්නපුර දිස්ත්‍රික්කය / இரத்தினபுரி மாவட்டம் / Ratnapura District': ['රත්නපුර / இரத்தினபுரி / Ratnapura', 'අයගම / அயகம / Ayagama', 'බලංගොඩ / பலங்கொட / Balangoda', 'ඇහැලියගොඩ / எஹலியகொட / Eheliyagoda', 'ඇලපාත / எலபத / Elapatha', 'කලවාන / கலவான / Kalawana', 'කිරිඇල්ල / கிரியெல்ல / Kiriella', 'කුරුවිට / குருவிட்ட / Kuruwita', 'නිවිතිගල / நிவித்திகல / Nivithigala', 'ඔපනායක / ஒப்பநாயக்க / Opanayaka', 'පැල්මඩුල්ල / பெல்மடுல / Pelmadulla', 'ඉඹුල්පේ	/ இம்புல்பே /	Imbulpe', 'ඇඹිලිපිටිය /	எம்பிலிபிட்டிய /	Embilipitiya', 'කොලොන්න /	கொலோன /	Kolonna', 'කහවත්ත /	கஹவத்தை /	Kahawatta', 'වැලිගෙපොළ /	வெலிகெபொல /	Weligepola', 'ගොඩකවෙල /	கொடகவெலை /	Godakawela', 'කල්තොට /	கல்தோட்டை /	Kalthota'],
      'කෑගල්ල දිස්ත්‍රික්කය / கேகாலை மாவட்டம் / Kegalle District': ['කෑගල්ල / கேகாலை / Kegalle', 'අරණායක / அரநாயக்க / Aranayaka', 'බුලත්කොහුපිටිය / புலத்கொஹுபிட்டிய / Bulathkohupitiya', 'දෙහිඕවිට / தெஹியோவிட்ட / Dehiovita', 'දැරණියගල / தெரணியகல / Deraniyagala', 'ගලිගමුව / கலிகமுவ / Galigamuwa', 'මාවනැල්ල / மாவனல்ல / Mawanella', 'රඹුක්කන / ரம்புக்கன / Rambukkana', 'යටියන්තොට / யட்டியந்தோட்ட / Yatiyantota', 'වරකාපොළ /	வரகாபொல	/ Warakapola', 'රුවන්වැල්ල /	ருவன்வெல்ல /	Ruwanwella']
    }
  }
};
...
const FIELD_OPTIONS = [
  ...
  { value: 'Beauty Salon', si: 'රූපලාවන්‍යාගාර', ta: 'அழகு நிலையம்', en: 'Beauty Salon' },
...
const formatAsterisk = (text) => {
  ...
  parts.forEach((part, i) => {
    result.push(part);
    if (i < parts.length - 1) {
      result.push(<span key={i} style={{ color: '#dc2626' }}>*</span>);
    }
  });
  return result;
};
...
const L = ({ si, ta, en, color }) => (
  <span style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
    <span style={{ display: 'block', color: color || '#0a192f', fontSize: '14px', fontWeight: '800', letterSpacing: '0.2px' }}>{formatAsterisk(si)}</span>
    <span style={{ display: 'block', color: color || '#112240', fontSize: '13px', fontWeight: '500', opacity: color ? 1 : 0.9 }}>{formatAsterisk(ta)}</span>
    <span style={{ display: 'block', color: color || '#6B7280', fontSize: '11px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px', marginTop: '1px' }}>{formatAsterisk(en)}</span>
  </span>
);
  ...
  <div style={styles.radioGroup}>
    {options.map(opt => (
      <label key={opt.value} style={styles.radioLabel} className="radio-label">
        <input type="radio" name={name} value={opt.value} checked={value === opt.value} onChange={onChange} style={styles.radioInput} required={required} />
        <span>
...
export default function CombinedForm() {
  ...
  useEffect(() => {
    ...
    if (day && month && year && year.length === 4) {
      ...
      if (personData.dob !== formattedDob || personData.age !== calculatedAge) {
        setPersonData(prev => ({ ...prev, dob: formattedDob, age: calculatedAge }));
      }
  ...
  }, [dobParts, personData.dob, personData.age]);
  ...
  const cOK = companyData.province && companyData.district && companyData.division && companyData.officeName && companyData.address && companyData.companyNature && companyData.officerName && companyData.contact && companyData.whatsapp && companyData.email && companyData.field && companyData.totalEmployees && companyData.permanentEmployees && companyData.temporaryEmployees && companyData.femaleEmployees && companyData.maleEmployees && companyData.hasJob && companyData.pay && companyData.epfEtf && companyData.hasTrainee && companyData.supplyTransport && (companyData.supplyTransport === 'No' || companyData.transportLimit) && companyData.supplyFood && companyData.supplyClothes && companyData.ageCategory && companyData.disability && companyData.disability.length > 0;
  ...
  const isEmploymentValid = !personData.currentlyEmployed || personData.currentlyEmployed === 'No' || (personData.currentlyEmployed === 'Yes' && personData.employmentNature && personData.currentEmploymentDetails && (personData.employmentNature !== 'Private' || personData.epfEtfPaid));
  const pOK = personData.province && personData.district && personData.division && personData.name && personData.idType && personData.idNo && personData.phone && personData.age >= 18 && personData.age <= 59 && personData.receivesAllowance && personData.receivesAswasuma && isEmploymentValid && personData.caretakerName && personData.caretakerMobile && personData.disability && personData.disability.length > 0 && personData.field && personData.field.length > 0 && personData.hasFieldExperience && (personData.hasFieldExperience === 'No' || (personData.experienceYears && personData.experienceInstitution));
    ...
    <div style={styles.container}>
      ...
      <div style={styles.card} className="form-card">
        ...
        <div style={styles.form}>
          ...
          <div style={{ background: 'linear-gradient(135deg,#eff6ff,#dbeafe)', border: '2px solid #3b82f6', borderRadius: '12px', padding: '22px 20px', marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'flex-start', textAlign: 'left' }}>
            <div style={{ width: '100%' }}>
              <p style={{ margin: '0 0 16px', color: '#1d4ed8', fontSize: '15px', fontWeight: '800', lineHeight: 1.4, textAlign: 'center', borderBottom: '1px solid #bfdbfe', paddingBottom: '12px' }}>
                පෝරමය පිරවීම සඳහා උපදෙස්<br />
                <span style={{ fontSize: '13px', color: '#1e3a8a' }}>படிவத்தை நிரப்புவதற்கான வழிமுறைகள் / Instructions for filling the form</span>
              </p>
              <ul style={{ margin: 0, paddingLeft: '20px', color: '#0a192f', fontSize: '14px', lineHeight: 1.6, fontWeight: '700' }}>
                <li>තනි භාෂාවක් පමණක් භාවිත කරන්න.<br /><span style={{ fontSize: '12px', fontWeight: '500', color: '#334155' }}>ஒரு மொழியை மட்டும் பயன்படுத்தவும். / Use a single language only.</span></li>
                <li style={{ marginTop: '12px' }}>
                  {isCompany 
                    ? <>ආයතනය පිහිටි ස්ථානයට අදාළ තොරතුරු ලබා දිය යුතුය.<br /><span style={{ fontSize: '12px', fontWeight: '500', color: '#334155' }}>நிறுவனத்தின் அமைவிடம் தொடர்பான தகவல்களை வழங்கவும். / Provide details related to the company's location.</span></>
                    : <>ඔබ දැනට පදිංචි ස්ථානයට අදාළ තොරතුරු ලබා දිය යුතුය.<br /><span style={{ fontSize: '12px', fontWeight: '500', color: '#334155' }}>உங்கள் தற்போதைய வசிப்பிடத்தின் தகவல்களை வழங்கவும். / Provide details related to your current residence.</span></>
                  }
                </li>
                <li style={{ marginTop: '12px' }}>
                  {isCompany
                ...
                {isCompany && (
                  <li style={{ marginTop: '12px' }}>
                    ආබාධ සහිත තැනැත්තන් රැකියා ගත කරන ආයතන සඳහා රජය මගින් සේවකයන්ගේ වැටුපෙන් 50% ක වැටුප් සහනාධාරයක් (රු. 15,000 ක උපරිමයකට යටත්ව) මාස 24ක් දක්වා ගෙවීම් සිදු කරනු ලැබේ. (EPF/ETF ගෙවන ආයතන සදහා පමණයි)<br />
                    <span style={{ fontSize: '12px', fontWeight: '500', color: '#334155' }}>
                      அங்கவீனமுற்ற நபர்களை வேலைக்கு அமர்த்தும் நிறுவனங்களுக்கு, அவர்களின் சம்பளத்தில் 50% ஐ (அதிக பட்சம் ரூபா. 15,000/- வரை) அரசாங்கம் 24 மாதங்கள் வரை சம்பள மானியமாக வழங்கும். (EPF/ETF செலுத்தும் நிறுவனங்களுக்கு மட்டுமே)<br />
                      For institutions employing persons with disabilities, the government will provide a wage subsidy of 50% of the employees' salaries (subject to a maximum of Rs. 15,000) for up to 24 months. (Only for institutions paying EPF/ETF)
                    </span>
                  </li>
                )}
              </ul>
          ...
          {isCompany && (<>
            ...
            <F si="අපේක්ෂිත වයස් කාණ්ඩය *" ta="எதிர்பார்க்கும் வயதுப் பிரிவினர் *" en="Age Category *">
              <select name="ageCategory" value={companyData.ageCategory} onChange={handleCompanyChange} style={styles.sel} required>
          ...
          {!isCompany && (<>
            ...
            <F si="සම්පූර්ණ නම *" ta="முழுப் பெயர் *" en="Full Name *">
            ...
            <F si="දැනට පදිංචි ලිපිනය *" ta="தற்போதைய வசிப்பிட முகவரி *" en="Current Residential Address *">
            ...
            <F si="දුරකථන අංක *" ta="தொலைபேசி இலக்கங்கள் *" en="Phone Numbers *">
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                <input type="tel" name="phone" value={personData.phone} onChange={handlePersonChange} style={{ ...styles.inp, flex: 1 }} maxLength={15} placeholder="0XX XXX XXXX (ප්‍රධාන/Primary *)" autoComplete="off" />
                <input type="tel" name="phone2" value={personData.phone2} onChange={handlePersonChange} style={{ ...styles.inp, flex: 1 }} maxLength={15} placeholder="0XX XXX XXXX (විකල්ප/Optional)" autoComplete="off" />
              </div>
            </F>
            <F si="උපන් දිනය" ta="பிறந்த திகதி" en="Date of Birth">
              ...
              {personData.dob && personData.age && (personData.age < 18 || personData.age > 59) && (
                <p style={{ color: '#ef4444', fontSize: '13px', marginTop: '6px', fontWeight: 'bold' }}>
                  වයස අවුරුදු 18 ත් 59 ත් අතර විය යුතුය. / வயது 18 முதல் 59 வரை இருக்க வேண்டும். / Age must be between 18 and 59.
                </p>
              )}
            </F>
            ...
            <F si="හැඳුනුම්පත් අංකය *" ta="அடையாள அட்டை எண் *" en="ID Number *">
              ...
              {personData.idType === 'Other' && (
                <input type="text" name="idTypeOther" value={personData.idTypeOther} onChange={handlePersonChange} placeholder="වෙනත් හැඳුනුම්පත් වර්ගය සඳහන් කරන්න / Specify other ID type" style={{ ...styles.inpOther, marginTop: '8px' }} maxLength={50} autoComplete="off" />
              )}
            </F>
            <F si="අස්වැසුම දීමනාව ලැබේද? *" ta="அஸ்வெசும கொடுப்பனவு கிடைக்கிறதா? *" en="Do you receive Aswasuma allowance? *">
              <RadioGroup name="receivesAswasuma" value={personData.receivesAswasuma} onChange={handlePersonChange} options={[
            ...
            <hr style={styles.divider} />
            <p style={styles.sectionTitle}>🤝 <L si="සම්බන්ධ කර ගත හැකි අයෙකුගේ තොරතුරු (ආබාධ සහිත පුද්ගලයා හැර)" ta="தொடர்பு தகவல் (மாற்றுத்திறனாளி தவிர)" en="Contact information (except the person with disability)" /></p>
            ...
            <F si="දුරකථන අංක *" ta="தொலைபேசி இலக்கங்கள் *" en="Mobile Numbers *">
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                <input type="tel" name="caretakerMobile" value={personData.caretakerMobile} onChange={handlePersonChange} style={{ ...styles.inp, flex: 1 }} maxLength={15} placeholder="0XX XXX XXXX (ප්‍රධාන/Primary)" autoComplete="off" />
                <input type="tel" name="caretakerMobile2" value={personData.caretakerMobile2} onChange={handlePersonChange} style={{ ...styles.inp, flex: 1 }} maxLength={15} placeholder="0XX XXX XXXX (විකල්ප/Optional)" autoComplete="off" />
              </div>
            </F>
            ...
            <F si="ආබාධිතතා වර්ගීකරණය *" ta="அங்கவீன வகைப்பாடுகள் *" en="Type of Disability *">
              <div>
                ...
                {(personData.disability || []).includes('Other') && (
                  <input type="text" name="disabilityOther" value={personData.disabilityOther} onChange={handlePersonChange}
                    style={styles.inpOther} maxLength={100}
            ...
            {personData.hasFieldExperience === 'Yes' && (
              <>
                <F si="වැඩිම කැමැත්තක් දක්වන ක්ෂේත්‍රයේ පලපුරුද්ද වසර කීයක්ද? *" ta="மிகவும் விரும்பிய துறையில் எத்தனை வருடங்கள்? *" en="How many years in the most preferred field? *">
                  <input type="text" name="experienceYears" value={personData.experienceYears} onChange={handlePersonChange} style={styles.inp} maxLength={20} placeholder="උදා: වසර 2 / எ.கா: 2 வருடங்கள் / e.g. 2 years" autoComplete="off" required />
                </F>
                ...
                <F si="වෙනත් හැකියාවක් තියේද? *" ta="வேறு ஏதேனும் திறன்கள் உள்ளதா? *" en="Do you have any other skills? *">
                  <input type="text" name="otherSkills" value={personData.otherSkills} onChange={handlePersonChange} style={styles.inp} maxLength={150} placeholder="උදා: පරිගණක ක්‍රියාකරු / எ.கா: கணினி ஆபரேட்டர் / e.g. Computer operator" autoComplete="off" required />
                </F>
          ...
          <>
            <hr style={styles.divider} />
            <F si="අදහස් සහ යෝජනා" ta="கருத்துகள் மற்றும் ஆலோசனைகள்" en="Remarks and Suggestions">
              <textarea name="remarks" value={isCompany ? companyData.remarks : personData.remarks} onChange={isCompany ? handleCompanyChange : handlePersonChange} style={styles.ta} rows={3} maxLength={500} autoComplete="off" placeholder="මෙහි ලියන්න / இங்கே எழுதவும் / Write here..." />
            </F>
          </>
